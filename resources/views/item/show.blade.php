                        ...
                        <div class="">
                          <div class="h-full flex sm:flex-row flex-col items-center justify-center sm: text-center">
                              ...
                              <div class="flex-grow sm:pl-8 text-center pt-2">
                                ...
                                <h1 class="title-font text-lg font-medium text-gray-900 mb-3">商品分類：{{ $item->category->primary->name }}</h1>
                                <h1 class="title-font text-lg font-medium text-gray-900 mb-3">アイテム：{{  $item->category->name }}</h1>
