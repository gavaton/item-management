                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200
                                                ease-in-out" value="{{ $item->name }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="number" id="price" name="price" required value="{{ $item->price }}" class="w-full bg-gray-100
                                                bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <div>
                                                    ...
                                                    accept="image/png/jpeg,image/jpg" onChange="imgPreView(event)">
                                                </div>
                                                <div class="pt-3">
                                                    <x-image-thumbnail :filename="$item->filename_one" />
                                                    <label for="image" class="leading-7 text-sm text-gray-600">画像2</label>
                                                    <input type="file" class="form-control" id="image1" name="image1" 
                                                    accept="image/png/jpeg,image/jpg" onChange="imgPreView1(event)">
                                                </div>
                                                <div class="pt-3">
                                                    <x-image-thumbnail :filename="$item->filename_two" />
                                        ...
                                        <div class="p-2 w-full flex justify-around mt-4">
                                            ...
                                            hover:bg-green-400 rounded text-sm">更新</button>                        
                                        </div>
                                    </div>
                                </div>
                            </form>
